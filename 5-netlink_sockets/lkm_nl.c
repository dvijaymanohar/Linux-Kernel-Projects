...
static void lk_nl_dev_handle_input(void)
{
  switch(cmd_complete_ev_data.cmd_ev_hdr2.params.fmr_hci_write_cmd_complete.cmd_opcode)
  {
    ...
    default:
      printk("lk_nl_dev: Invalid cmd response recieved\n");
      break;
   }
}
