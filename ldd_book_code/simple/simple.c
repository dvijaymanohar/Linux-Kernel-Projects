...
void qpc_sdac_vma_open(struct vm_area_struct *vma)
{
	printk(KERN_NOTICE "Simple VMA open, virt %lx, phys %lx\n",
			vma->vm_start, vma->vm_pgoff << PAGE_SHIFT);
}

void qpc_sdac_vma_close(struct vm_area_struct *vma)
{
...
static struct vm_operations_struct simple_remap_vm_ops = {
	.open =  qpc_sdac_vma_open,
	.close = qpc_sdac_vma_close,
};
 ...
 * The nopage version.
 */
struct page *qpc_sdac_vma_nopage(struct vm_area_struct *vma,
